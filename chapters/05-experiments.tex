...
\todo[inline]{Add note for Kneser-Ney NLL metric}
...
\begin{table}[ht]
	...
	\begin{tabular}{| c | l | r | r | r | r |}
		\hline
		\multirow{2}{*}{} & \textbf{Model}        & \textbf{Transfer} & \textbf{Content}      & \textbf{Word}    & \textbf{Negative}       \\
		                  &                       & \textbf{Strength} & \textbf{Preservation} & \textbf{Overlap} & \textbf{Log-Likelihood} \\
		\hline
		\hline
