...
\begin{table}[ht]
	...
	\begin{tabular}{| l | r | r | r | r |}
		\hline
		\multirow{2}{*}{\textbf{Objectives}}                                                                     & \textbf{Transfer} & \textbf{Content}      & \textbf{Word}    & \textbf{Language} \\
		                                                                                                         & \textbf{Strength} & \textbf{Preservation} & \textbf{Overlap} & \textbf{Fluency}  \\
		\hline
		\hline
		$\mathcal{L}_\text{rec}$                                                                                 & 0.1436            & \textbf{0.9154}       & \textbf{0.3288}  & 14.2781           \\
		\hline
		...
		\hline
		$\mathcal{L}_\text{rec}$, $\mathcal{L}_\text{adv}$, $\mathcal{L}_\text{mult}$                            & \textbf{0.8903}   & 0.8824                & 0.2105           & 14.4099           \\
		\hline
		...
		\hline
		$\mathcal{L}_\text{rec}$, $\mathcal{L}_\text{adv}$, $\mathcal{L}_\text{mult}$, $\mathcal{L}_\text{badv}$ & 0.8846            & 0.8782                & 0.1970           & \textbf{14.0479}  \\
		\hline
	\end{tabular}
