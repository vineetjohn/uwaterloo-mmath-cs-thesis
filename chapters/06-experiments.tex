...
\begin{table}[ht]
	...
	\begin{tabular}{| l | r | r | r |}
		\hline
		\multirow{2}{*}{
		\textbf{Objectives}}                                                                                     & \textbf{Style}    & \textbf{Content}      & \textbf{Word}    \\
		                                                                                                         & \textbf{Transfer} & \textbf{Preservation} & \textbf{Overlap} \\
		\hline
		\hline
		...
		\hline
		$\mathcal{L}_\text{rec}$, $\mathcal{L}_\text{adv}$, $\mathcal{L}_\text{badv}$                            &                   &                       &                  \\
		\hline
		$\mathcal{L}_\text{rec}$, $\mathcal{L}_\text{mult}$, $\mathcal{L}_\text{badv}$                           &                   &                       &                  \\
		\hline
		$\mathcal{L}_\text{rec}$, $\mathcal{L}_\text{adv}$, $\mathcal{L}_\text{mult}$, $\mathcal{L}_\text{badv}$ &                   &                       &                  \\
		\hline
	\end{tabular}
