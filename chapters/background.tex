...
\begin{figure}[ht]
	...
	\imgsrc{https://commons.wikimedia.org/wiki/File:Recurrent_neural_network_unfold.svg}
...
\begin{figure}[ht]
	...
	\imgsrc{http://www.wildml.com/2015/09/recurrent-neural-networks-tutorial-part-1-introduction-to-rnns}
...
\begin{figure}[ht]
	...
	\imgsrc{http://mlexplained.com/2017/12/28/an-intuitive-explanation-of-variational-autoencoders-vaes-part-1}
...
\todo[inline]{Add original GAN paper}

\todo[inline]{Add original neural style transfer paper}
