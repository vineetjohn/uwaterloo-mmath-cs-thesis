...
\hypersetup{
    ...
    pdftitle={Disentangled Latent Representation Learning for Stylistic Variation in Language Models},    % title: CHANGE THIS TEXT!
    ...
    pdfsubject={Natural Language Processing},  % subject: CHANGE THIS TEXT! and uncomment this line
   	pdfkeywords={nlp} {deep-learning} {style-transfer}, % list of keywords, and uncomment this line if desired
